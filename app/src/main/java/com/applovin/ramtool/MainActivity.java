...
//            String result = memAllocAidlInterface1.testLatency();
            ...
            l1CacheLatencyTextView.post(() -> {
                ...
                l1CacheLatencyTextView.setText(DataProcessor.getInstance().getL1CacheLatency() + "ns");
                memoryLatencyTextView.setText(DataProcessor.getInstance().getMemoryLatency() + "ns");
